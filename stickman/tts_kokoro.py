...
# Modely hladame v <repo>/kokoro (tam ich cachuje aj Actions), inak v ~/kokoro.
...
def kokoro_dir(cfg_dir=None):
    for c in (cfg_dir, os.environ.get("KOKORO_DIR"), os.path.join(ROOT, "kokoro"),
              os.path.join(os.path.expanduser("~"), "kokoro")):
